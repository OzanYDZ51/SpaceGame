...
var npc_ids: Array[StringName] = []  # all NPCs spawned for this event (mutable — killed NPCs get erased)
var all_spawned_ids: Array[StringName] = []  # immutable copy of all NPC IDs ever spawned (for cleanup)
