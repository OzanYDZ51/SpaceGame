...
func _draw_route_panel(ctrl: Control) -> void:
	...
	ctrl.draw_string(font, Vector2(8, 15), "ROUTE: " + dest_name, HORIZONTAL_ALIGNMENT_LEFT, s.x - 16, 11, Color(0.0, 0.9, 1.0, pulse))
	...
	ctrl.draw_string(font, Vector2(8, 30), jump_text, HORIZONTAL_ALIGNMENT_LEFT, 100, 10, Color(0.6, 0.8, 0.9, 0.8))
	...
	if state_text != "":
		ctrl.draw_string(font, Vector2(s.x - 8, 30), state_text, HORIZONTAL_ALIGNMENT_RIGHT, 100, 9, Color(1.0, 0.8, 0.0, pulse * 0.8))
